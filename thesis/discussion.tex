...
\todo[inline]{Following is preliminary phrasing}
...
\todo[inline]{Just describe the areas here and what is different from the usual
procedure; implications (a.k.a. pros \& cons) later}
...
% any preprocessing steps can be rerun
...
% essentially, an issue of opportunity costs.
...
\paragraph{Opportunity costs' example: missing ROIS of RSC \& OPA}
...
\paragraph{Publish data, materials, results}
