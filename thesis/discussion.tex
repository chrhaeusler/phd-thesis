...
\todo[inline]{incentives; questionable immediate reward?}
...
Creating a reproducible study also helps to create a well-organized and
...
% opportunity costs
Opportunity costs: Follow a chosen path or do it all from scratch again?
%
...
\todo[inline]{This might be to personal; nobody (me included) cares about the my
life's journey}
...
\todo[inline]{Data re-use: I could write that I pulled my hair out while
searching for inconsistencies in the timings, and found that the audio track of
the audio-description is essentially unsystematically shifted; similar cases
stay probably undiscovered in non-open datasets}
...
glad having documented, version-controlled, automatized stuff (maybe, materials
are a little better organized or my code was a little better to grasp again, I
don't know)}
...
% actually, embrace the following:
...
\subsubsection{Interests of science}
...
\subsubsection{Interest of society}
...
``The transition to a more open scientific culture will only be successful if
