...
\todo[inline]{Following is preliminary phrasing; more important:
%
...
\todo[inline]{in general there are to ways to structure it: a) do a
"theoretical" part with stuff I stumbled across (but do not get personal) and
write a personal assessment with examples at the end; or b) write the
theoretical parts, each followed by an example from current thesis}



\subsection{Contra}

\todo[inline]{imo, the whining should be concise \& kept to the most relevant
points; ideally, summed up in 1-2 paragraphs (before "Two-sided stuff")}
...
\todo[inline]{Personal example: I have fond memories of trying to automate the
stacked surface plots; I don't know if it makes sense to give that as a (super
annoying example)}
...
\paragraph{Publishing data[, results, paper]}

\todo[inline]{imo, irrelevant in my case: statement of agreement, anonymization}

\todo[inline]{cf. FAIR principles}

\todo[inline]{points regarding "open paper"? speech anno paper is on github; ppa
paper is not a public github repository (yet)}

\todo[inline]{somehow bring up DataLad format \& software; skim DataLad paper}
...
\todo[inline]{Personal example: I fondly remember waking up on Sunday 2019-12-15
(still drunk after a Christmas party) with a message in matrix from you pointing
me towards \citep{jiahui2020predicting}}



\subsection{The kind of two-sided stuff}

\subsubsection{Dataset creators vs. dataset consumers}
...
\todo[inline]{Personal example: I could write here that I pulled my hair out
while searching for inconsistencies in the timings, and found that the audio
track of the audio-description is essentially unsystematically shifted}
...
\todo[inline]{fucking finally shorten this part!}
%
...
\todo[inline]{might get too personal; Nobody (me included) cares about the
...
\todo[inline]{Retrospectively, I cannot remember one case which made me glad
having documented, version-controlled, automatized stuff (maybe, materials are a
little better organized or my code was a little better to grasp again, I don't
know)}
...
\todo[inline]{check last part in Florez et al. (2021): 5.2. Implications for the
Development of OS Policies and Training Programs}
