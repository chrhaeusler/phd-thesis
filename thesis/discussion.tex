...
% data-related
a) acquiring open data and assessing their quality,
%
b) collection, description and storage of data,
%
...
\subsection{Acquiring open data and assessing their quality}
...
\subsubsection{Pros from perspective of consumers}
...
\subsubsection{Cons from perspective of consumers}
...
\subsection{Collection, description and storage of data}
...
\subsubsection{Cons from perspective of creators}
% jeez! it's annoying!
...
\subsubsection{Pros from perspective of creators}
...
\subsection{Automatize all that shit: processing \& analyzing data via code}

Often forgotten, but open-source packages were prerequisite and done by others
"that like to share".


\paragraph{personal whining}
...
\subsubsection{It sucks hard (if you do it)}
...
Template from \citet{jiahui2020predicting}: ``We found more reliable estimates
