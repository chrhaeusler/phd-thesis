...
\todo[inline]{Do not get too much into details (of results); this will be done
after the open-science-excurse}

\todo[inline]{Priming open science \& write a good transition to the theory part
of open science (it's an excursion and "super meta" for a thesis)}
...
\todo[inline]{a.k.a. overview about what was done (including what not necessary
but contributed to open science project)}
...
\todo[inline]{at the moment the idea is: discuss open science in general (i.e.
in a block); then apply the general stuff to the thesis (i.e. in a block); but
do not get too much into details regarding results}
...
\todo[inline]{Do not talk about concrete results in detail}
...
\todo[inline]{This is the part most similar to "Specific objectives and
hypothesis}
