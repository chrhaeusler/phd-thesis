...
an excursion and doesn't fit in anywhere perfectly; at the moment it comes
...
\todo[inline]{Revise with general intro \& SRM part: localizer is standard, but
problematic; it is reliable, but construct? ecologically validity? boring,
compliance, inefficient; therefor: naturalistic stimulus}
...
\todo[inline]{Prime the four topics to be discussed here}

\todo[inline]{below, try to make one paragraph per topic with definition,
example from current thesis, pro, con; then, delete subsections' titles}
...
\todo[inline]{maybe, "raw" and "preprocessed" open data can be merged}
...
\todo[inline]{Automatization is the most annoying part; but keep that for
personal assessment later}
