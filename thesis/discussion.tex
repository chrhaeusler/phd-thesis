...
\todo[inline]{revise given that part on functional alignment is now in the
thesis}
...
\paragraph{Functional localization via estimation from reference group}
...
\todo[inline]{add functional alignment + vision}
