...
\todo[inline]{add summary of findinds of the studies in 2-3 sentences? imo, no;
here is "priming" before "Open Science"; actual discussion is after "Open
Science"}
...
\todo[inline]{revise when discussion, conclusion and abstract of SRM is fix}
...
\todo[inline]{maybe, add some stuff from interim summaries)}
...
%
In contrast, naturalistic stimuli more closely resemble the complexity and
richness of real-world experiences, leading to responses in multiple brain
regions simultaneously.


\subsection{We: PPA model-driven and data-driven estimated (add that)}
%
...
a traditional visual localizer.
%
We found that model-driven analysis based on annotations of a movie and
its audio-description can yield results that are consistent with previous
studies using a visual localizer
% further studies
...
%
The thesis also highlights challenges naturalistic stimuli.
%
...
methodological and statistical issues, and to eventually adapt traditional
analysis approaches and foster the development of new analysis methods.
...
experiment that employs a naturalistic stimulus, should also consider to
eventually share the data with the scientific community.
% consider sharing
...
%
It is important to note that the naturalistic stimuli should not necessarily be
expected to yield the same results as traditional paradigms.
%
Traditional localizers aim to minimize individual variation and reliably
...
%
%
However, naturalistic paradigms allow participants to behave more genuine during
an experiment, potentially revealing individual differences in perception and
cognition that may also be correlated with the genuine behavior in the real
world.
%
Therefore, naturalistic stimuli should not seek to replace traditional
paradigms.
%
They should be used in conjunction to test findings under more ecologically
valid conditions, generate new hypotheses, and advance our understanding of the
brain and human behavior outside of the laboratory
\citep[cf.][]{jaaskelainen2021movies, sonkusare2019naturalistic}.


\paragraph{Actual conclusion}
%
In summary, researchers must carefully consider the strengths and limitations of
naturalistic stimuli and use appropriate methods to address these challenges.
%
Naturalistic stimuli can provide an engaging and more ecologically valid
alternative to traditional localizer paradigms, and it is important for
researchers to acknowledge the strengths and limitations of both paradigms.
%
The potential of naturalistic stimuli to replace one if not multiple traditional
localizers relies on addressing methodological and statistical challenges of
