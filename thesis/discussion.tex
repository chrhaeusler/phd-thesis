...
\todo[inline]{personal assessment are merged into the general text and no
separate subsection anymore; phrasings need some revisions though}
...
\todo[inline]{phrase pro DataLad but also mention that it changed constantly and
functionality grew over the course of the project}
...
\ac{frmi} data from new subjects.
%
...
pipeline".
%
In the present, it was very advantageous to have already been involved in the
data collection and being rather familiar with the data's location,
...
``given enough eyeballs, all bugs are shallow'' \citep{raymond1999cathedral}.
...
%
In order to increase transparency, data and custom code generated over
the course of this dissertation are version-controlled, and changes made to data
and code were protocolled and documented.
%
...
% contra
From a negative point of view, creating data, materials, and code to be
published requires a considerable about of time and effort.
%
...
Before publishing Especially when data are supposed to be published, a
researcher needs consider legal issues (e.g. intellectual property rights, use
license, statement of agreement and anonymization of participant data,
anonymization), facilitate discovery by humans and web bots (e.g., via extensive
description and machine-readable metadata), and ensure long-term curation and
accessibility at an appropriate data host.
%
From a positive point of view, creating a dataset that is supposed to be
published provides immediate benefits to the dataset's creator.
%
...
project was not mandatory for submitting the thesis but required considerably
...
development to implement said standards and practices (e.g., DataLad's recently
added support of software containerization)\todo{is "Fairly big" the
corresponding paper?}.
%
Pursuing the higher goal of contributing to tackle the replication crisis, or
``gambling'' on getting cited for data reuse does not justify preparing and
maintaining openly shared datasets.
%
Especially, designing and testing fully automated processing of data or creation
of complex figures for the perceived pure sake of replicability is out of
proportion to the immediate benefit of, e.g., easier bug tracking or simply
``higher confidence in one's own work''.
%
...
simply overlooked errors, or being ``scooped'', i.e. the risk that other working
groups are using the same data for a similar research question at the same time,
eventually claiming priority to a research idea or result
...
%
Hence, in my fucking opinion, the required time and effort heavily outweigh
immediate benefits.
...
%
In summary, risks, benefits and best practices of open science, and hands-on
training of related software packages should be introduced in undergraduate
programs already.
%
For graduate students, incentives to conduct open science project should be
established.
...
%
After all, as least as I see it, open sciences is the best way to make
%
a) researchers accountable to collect, document, process, store and publish data
and materials according to best practices,
%
b) Open transparent science is the way to make knowledge and technologies widely
accessible.
%
bb) increase robustness and reliability of science, and
%
c) ultimately increase efficiency of the scientific progress, promote
innovation, and increase trust of the public into scientific process and its
results.
