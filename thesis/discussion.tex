...
\todo[inline]{Somehow merge the two subsections "specifically" and "generally"}
...
\todo[inline]{This does not really fit in here anymore; put it somewhere else or
merge it into another part}
...
\todo[inline]{state functional domains sampled during naturalistic stimuli}
...
room for more individual variation that is difficult to record (or self-report);
especially shitty when individual variation is considered noise}
...
\todo[inline]{Somehow get back to nat. stim. as functional localizer? No
stimulus fits all}
