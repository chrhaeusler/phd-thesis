...
\todo[inline]{Here, prime the structure of the rant: models and their
assumptions, all that shit has annotations as prerequisite}
...
\subsection{Modeling \& controlling}
...
\subsubsection{Demons to some, angels to others}
...
\todo[inline]{interested in group average or individual differences?; cf.
Elliott}
