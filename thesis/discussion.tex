...
\todo[inline]{actually, almost the whole subsection "Personal assessment"
could be merged into the part above}
...
"landscape is moving too much" still; concrete standards, tools might be
outdated quickly}
...
\todo[inline]{is following in line with "aims of thesis" \& "specific aims and
objectives"?}
...
% validation analysis conclusion
...
\todo[inline]{following is the same text as in general intro's ``specific
objectives''}
...
\todo[inline]{Length, sampling of events}
...
\todo[inline]{check \citet{delavega2022neuroscout}; cf. also
\citet{haeusler2022processing}'s discussion}
...
\todo[inline]{data from naturalistic stimuli can be analyzed using model-driven
analyses based on stimulus annotations: but no simple mapping of methods from
controlled paradigms to naturalistic stimuli}

\todo[inline]{There is no localizer based on naturalistic stimuli for a reason}
...
\todo[inline]{probably, it is better to discuss it here more than in the SRM
part}
...
\todo[inline]{Maybe, reduced to one sentence on the conclusion?}
