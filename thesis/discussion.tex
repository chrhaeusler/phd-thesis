...
is premise for "fingerprints"; hence, following paragraphs are a draft}
...
\todo[inline]{imo, RSC and OPA do not need to be discussed in general discussion}

\todo[inline]{might make sense to be discussed in SRM study}
...
\todo[inline]{imo, just a side note; not necessarily needed to be discussed}
...
\todo[inline]{maybe, shift some sentences up}
