...
\todo[inline]{if points are correct, extend}
...
\todo[inline]{add sentence of data-driven estimation via functional alignment}
...
%
We found that a model-driven analysis based on annotations of stimuluts features
...
heart rate, and followed with self-reports to evaluate a participant's alertness
and audio track audibility within the noisy scanner.
%
...
but should be used to test findings under more ecologically valid conditions,
generate new hypotheses, and advance our understanding of the brain and human
behavior outside of the laboratory.


\subsection{Actual conclusion}
%
In summary, naturalistic stimuli can provide an engaging and more ecologically
valid alternative to traditional localizer paradigms, and it is important for
