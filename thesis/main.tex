...
% LaTex standard is Knuth's "Computer Modern" with serifs
...
% just use APA-style bibiliography
...
\todo[inline]{Own publications are listed here, if applicable. Submitted
    manuscripts / manuscripts under revision are not listed here. These will be
