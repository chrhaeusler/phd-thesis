\input{newcommands/descr-stats-anno-anno-paper.tex}
\input{newcommands/descr-stats-regressors.tex}
...
\todo[inline]{Original plan using IBM Watson and Google Cloud failed}
...
\todo[inline]{better add subsections with Participants, etc.}
