...
\todo[inline]{we tried mask based on adjacent gyri but it were to many voxels}
% masks created in fsleyes
% datalad save -m 'add probablistic ROIs extracted from fsleyes (Harvard-Oxford & MNI Prob Atlas)'
% manually add masks-from-mni-to-subj-space.py
