...
\citep[e.g., MNI152 atlas;][]{fonov2011unbiased}.
...
training subjects, we used the probabilistic \ac{srm} algorithm that is and
...
\subsection{(Partial) alignment of test subjects to a fixed \ac{cfs}}
...
space, we then used the transpose of the transformation matrix that we acquired
...
\paragraph{...and possibly other paradigms}
%
