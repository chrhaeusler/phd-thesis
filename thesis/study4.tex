...
\todo[inline]{Feels like it took one hour to explain what was done; sounds
better now but still overly complex}
...
\todo[inline]{make colors of non-used TRs of the model more transparent}
...
shared responses (trimmed to \acp{tr} that match the \acp{tr} of the movie)
can be seen in Fig.~\ref{fig:corr-av-reg-srm}.
%
The correlations between regressors that were created to model hemodynamic
responses during the audio-description \citep[cf. Table 3
in][]{haeusler2022processing} and shared responses (trimmed to \acp{tr} that
match the \acp{tr} of the audio-description) can be seen in
...
\todo[inline]{Add representation of the model to the plots}

\todo[inline]{Results suggest that... ???, "no meaningful shared responses";
"random shared response"; "shared responses that to not represent hemodynamic
