...
providing roughly the same amount of \acp{tr} to calculated the \ac{cfs} and
...
is approaching a performance limit, and longer scanning sessions during
audio-visual stimulation may not yield substantial benefits.
...
function, including speech perception, music perception, spatial cognition,
emotions, and theory of mind \citep[s.][for a review]{jaaskelainen2021movies}.
%
...
%
Our results suggest that $\approx$\unit[15]{min} \ac{frmi} scanning during a
naturalistic stimulus capturing a wide range of brain states could provide
sufficient data for a functional \textit{calibration scan}.
%
...
perception, as well as cognition.
%
...
dissimilarity) between a new subject's actual pattern and the pattern estimated
from a normative reference group.
%
