...
and b) the whole movie ``Forrest Gump'' ($\sim$\unit[120]{m}; \ac{tr}=\unit[2]{s}) in order to
estimate $Z$-maps resulting from a visual localizer $t$-contrast (hence, a
\textit{cross-paradigm prediction}) that aimed at localizing the \ac{ffa}.
% summary of results
