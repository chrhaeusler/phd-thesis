...
\todo[inline]{after having focussed on the discussion for a while: probably,
\citet{haxby2011common}'s findings on validity and generalizability need to be
better primed; text location \& phrasing depends on the discussion, though}
...
concatenated response time series to [of / from???] a movie, an
audio-description and a visual localizer from $N-1$ \textit{training subjects}
as seen in in Fig.~\ref{fig:multi-stimulus-cfs}.


\todo[inline]{Localizer in smallest part. Say something about the relative
impact on the shared response}

\todo[inline]{Combination of red and green is shitty}
...
\begin{figure*}[tbp] \centering
    ...
    %
    \textbf{to do: if plot is supposed to stay, it needs a legend for medians
...
\begin{figure*}[tbp] \centering
    ...
    %
    \textbf{to do: keep underlying boxplots (including mean \& median)??
    add median of Cronbach's, too? At least use the same line style as in
    Fig.~\ref{fig:cronbachs}.
    }
}
    \label{fig:stripplot}
\end{figure*}
