...
instructions were presented on a rear-projection screen inside the scanenr bore
...
\subsubsection{Quantifiying the performance}
...
\todo[inline]{use Jiahu as fuckin template}
