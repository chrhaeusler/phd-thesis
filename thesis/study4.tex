...
\todo[inline]{imo, explaining 1 example, \citet{jiahui2020predicting}, is okay}
...
\todo[inline]{we do not really estimate maps but just ``values in a ROI''}
...
\todo[inline]{draft of phrasing; cf. general introduction}
...
\todo[inline]{maybe, shift the math shit from intro to here}
...
\todo[inline]{starting here, the quality declines...}
...
\todo[inline]{Results and methods need rigorous cleaning! Better do not read!}
