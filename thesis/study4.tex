...
%
\todo[inline]{Add inference: These results are in line with
\citep{haxby2011common} who showed that...}
%
...
%
\textbf{First}, it is possible that the audio-description is ``not as rich'' as
...
\todo[inline]{better convey that responses to spatial information during audio
might be different but time series can still be used to predict visual paradigm}

\todo[inline]{problem: maybe, the maps are well estimated in the anterior part
but badly estimated in the posterior part}
...
do not significantly degrade the model.  \todo{be careful!}
%
...
denoising a test subject's data \citep[cf.][]{cohen2017computational,
chen2015reduced}.
%
\todo{check}
%
...
calculated from time-series with added artificial noise.
%
\todo{if you know what I mean}
