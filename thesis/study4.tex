...
\todo[inline]{Topography = the spatial configuration and organisation of
functional regions; network topography  (i.e. spatial shape, size and position
of functional regions \citep{bijsterbosch2018relationship}}

\todo[inline]{probabilistic maps have problems with overlapping areas; strict
binary ROIs / parcellation does not make sense, imo, anyway}

\todo[inline]{``Cortical locations in different individ- uals are in functional
correspondence if they are part of the same cortical area and are matched in
terms of whatever is mapped within that area. For example, each point in the
visual field (e.g., the center of the foveal representation) can be used to
define corresponding locations in area V1 of different individuals''
\citep{vanessen2007surface}}

\todo[inline]{they do not capture the idiosyncrasies of the maps within a ROI
