\todo[inline]{any parts to drop? stuff that I just tried like "alternative
template creation" (cf. end of methods)}
...
A previous study compared ``the location of functionally localized regions
...
\todo[inline]{has \citet{rosenke2021probabilistic} more on PPA?}

% rephrase better: works better with retinotopic areas than category-specific
% areas
...
\todo[inline]{here are similarities, shift dissimilarities down}
...
\todo[inline]{mih: very dense. This could be a full paragraph}
...
\todo[inline]{we do not just predict binary outcome of an probabilistic atlas}
