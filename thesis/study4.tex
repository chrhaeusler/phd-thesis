...
statistical tests) to make the point}
...
\todo[inline]{cite studies (or review) that did research on other brain
functions using naturalistic stimuli}
...
\todo[inline]{In general, avoid a big treatise about different algos}
...
\todo[inline]{Any other short comings (most is implicitly mentioned in "Future
Questions")}
