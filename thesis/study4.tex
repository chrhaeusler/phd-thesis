...
\todo[inline]{Feels like it took one hour to explain what was done; sounds a
...
\todo[inline]{Plots of based on shuffled runs could be placed in an appendix}
...
\todo[inline]{Regressoren besser erklären; Regressors based on annotations vs,
low-level regressors (used as nuisance regressors); dennoch auf Table 3
verweisen}
...
\centering
    ...
    \caption{
    %
    \textbf{Correlations between regressors of the audio-description and
    shared features during corresponding \acp{tr}.}
    %
    Pearson correlation coefficients between regressors
    created in \citet{haeusler2022processing} to model hemodynamic responses to
