...
%
Our findings indicate that $\approx$\unit[15]{min} of localizer or movie data
...
alignment.
%
A possible first explanation for the poor performance might be that the
...
be that neural responses in the \ac{ppa} to an auditory paradigm might differ
...
%
The three participants with poor Cronbach's $\alpha$ also represent the three
...
%
Therefore, the reliability of the audio-description's $Z$-maps might be poor in
