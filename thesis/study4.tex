...
alignment.
%
A possible explanation of these results might be that the audio-description
offers a less diverse stimulation and has a sparser event structure that does
not sample the targeted responses as comprehensively leading to the
comparatively low prediction performance.
%
...
%
Therefore, a second, not mutually exclusive, explanation of these results might
be that neural responses in the \ac{ppa} to an auditory paradigm might differ
from responses to a visual paradigm, and therefore contributing to the lower
estimation performance.
%
...
are more abstract and of more general utility'' \citep[][p.
409]{haxby2011common}.
%
...
results of a visual paradigm, however at the expense of a long scan session.
...
prediction via the anatomical alignment.
%
...
independent of the amount of data used for functional alignment.
%
Results suggest that these participants are not outliers showing a response in
the \ac{ppa} that is consistently deviant from the norm but rather exhibited
more variable responses to auditory spatial information during the two-hour
stimulation.
%
...
audio-description could still be used to acquire transformations that enabled
the estimation of the visual paradigms' results.
%
