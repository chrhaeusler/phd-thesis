...
alignment over transformation matrices based on data of a paradigm based on
simplified stimuli.
%
...
\paragraph{But anatomical alignment is not bad}

In case the audio-description is estimated (and when "not a lot" of data for
functional alignment are used).
%
Which is also true when audio-description is used for alignment to estimate the
movie PPA (in that case the amount of data doesn't matter).
%
Maybe, the outliers fucked up the model?


\paragraph{Partial Alignment}

\todo[inline]{"asymptopic relationship", "ceiling", "saturation"?}

\todo[inline]{Merge sentences making the same point}
...
\todo[inline]{This also a point for the general discussion: how far can you push
it?}

\todo[inline]{Just discuss here what has been shown to work based on
naturalistic stimuli}

\todo[inline]{cite studies that did research on other brain functions using
naturalistic stimuli; the awesome response vector space should be sampled by a
movie or narrative (language, memory, emotions etc.)}
