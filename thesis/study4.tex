...
%
\texttt{fahead}: face or head (parts);
%
...
%
\texttt{object}: countable entities with firm boundaries;
%
\texttt{se\_new}: a setting occurring for the first time;
%
\texttt{se\_old}: a recurring setting;
%
\texttt{sex\_f}: female person(s), name;
%
\texttt{sex\_m}: male person(s), name;
%
...
\begin{figure*}[tbp] \centering
    ...
    (CFS): runs of the visual localizer paradigm lasted \unit[5.2]{min};
