...
separately before concatenating the time series and calculating the shared
responses.
%
...
neural responses as comprehensively due to a sparser event structure.
%
...
auditory experiment, such as a speech localizer, that yields more
...
\todo[inline]{revise; as is, last point seems to contradict first point}
...
experiments such as the visual localizer paradigm used in our study.
%
...
guntupalli2016model} could cover the entire cortex but restricts the
simultaneously aligned voxels to those within the searchlight's sphere.
%
...
reorganization, e.g., after brain injuries.
...
voxel space.
%
This enables the estimation of regular patterns in the new subject when
...
\todo[inline]{revise when rest of paper is fix (print, mark main points)}
