...
\todo[inline]{well, but why then do you want to predict results of unecological
paradigm?}
...
\todo[inline]{the more I think about it: we do not need to explain anatomical
alignment first but can directly explain functional alignment; anatomical
alignment get introduced later as a ``benchmark''}
...
\todo[inline]{explain that you will use the term \ac{cms} for the shared feature
space of the \ac{srm}, too}
...
\paragraph{results from hyperalignment studies}
%
