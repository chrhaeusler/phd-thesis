...
\todo[inline]{cf. plot of TRs of top 3 shared responses in the \ac{cfs}}
...
\todo[inline]{...which leads to "the Vision"}


\subsubsection{"Problem": our matrices based on localizer generalize amazingly
well}
