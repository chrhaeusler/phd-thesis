...
\todo[inline]{Does not convey a lot of info, but put plot of voxels here}
...
$SD=188$).\todo{wrong figure linked}
...
\todo[inline]{What to adjust in the plots?}
...
\todo[inline]{Write better intro sentence; cf. e.g., Cohen}

\todo[inline]{Phrasing! Validity, generalizability, and stuff!}
...
\todo[inline]{Compare following phrasings to phrasing in the introduction!}

\todo[inline]{In doubt, more details here}
...
\todo[inline]{Old phrasings (might be pretty similar to the above text}
%
