\todo[inline]{subject vs. participant? it's "participant" in PPA paper + general
intro \& discussion}

\todo[inline]{negative control: shuffle runs within or across paradigms? imo,
across...}

\todo[inline]{finalize figures and figure captions}
...
criteria, and comparison to the volume-based, anatomical alignment}
...
sentences like in the abstract; mention "partial alignment"}
...
\todo[inline]{vision is here in the SRM part}

\todo[inline]{I will only shortly mention it in the general discussion when
discussing pro (\& contra) of naturalistic stimuli}
