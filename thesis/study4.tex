...
\todo[inline]{get rid of term "partial alignment"; it's more confusing than
helpful}
...
performed a \textbf{partial alignment} of the \textit{test subject}:
%
...
last sentence)? mention: number of minutes, generalization of predictors across
criteria, and comparison to the  non-linear volume-based, anatomical alignment}

\todo[inline]{add 1 sentence stating a conclusion (\& vision)?}

\todo[inline]{should be similar to the possible end of the discussion's first
paragraph}
...
%
This \textbf{partial alignment} with the \ac{cfs} produced different
transformation matrices for the test subject based on data from different
paradigms.
...
\todo[inline]{imo, runs should be shuffled across paradigms, not just within
paradigms}
...
\todo[inline]{vision is here; in general discussion just mentioned as pro of
nat.  stim.}
...
\todo[inline]{same text as in PPA-Paper but with new GIN link (leading to an
empty repo)}
