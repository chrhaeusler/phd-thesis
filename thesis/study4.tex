...
\todo[inline]{can't remember: is grand mean per run or across runs?}

\todo[inline]{make sure that all mentioned steps have actually been applied to
'filtered\_func\_data.nii.gz' serving as input for following SRM-scripts}
...
of the preprocessing, mean values were subtracted again, and each voxels' time
