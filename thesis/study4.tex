...
\todo[inline]{Make this part shorter as an introduction}
...
stimuli
%
to align the test subject's time series to the their corresponding \acp{tr}
within the \ac{cfs}.
%
...
% use numprint's nprounddigits to round, well digits
% e.g. \nprounddigits{2}\numprint{13.9978}$
