...
\todo[inline]{last sentence mentioning partial alignment does not really fit in
there but is kinda necessary because readers will wonder where the difference to
\citep{jiahui2020predicting} is (except they do FFA, we do PPA)}
...
\todo[inline]{imo, the following part on SRM should be kept to a minimum}
