...
\todo[inline]{We also estimate the "auditory PPA" localized in x of subjects
from PPA study}
...
\todo[inline]{maybe, add that we also use the $Z$-maps of the "auditory PPA"
from \citet{haeusler2022processing}}
...
\paragraph{correlation of regressors in the studies with shared responses}

\todo[inline]{imo, add the correlation matrices of regressors and shared
responses should here already (as we did it in the PPA paper, too).}
...
%
VIS regressors vs. shared responses see Figure~\ref{fig:corr-vis-reg-srm}.
%
AV regressors vs shared responses see Figure~\ref{fig:corr-av-reg-srm}.
%
AO regressors vs shared responses see Figure~\ref{fig:corr-ao-reg-srm}.
...
\includegraphics[width=\linewidth]{figures/corr_vis-regressors-vs-cfs_sub-01_srm-ao-av-vis_feat10-iter30_7123-7747.pdf}
    \caption{
    %
    Correlations of regressors of visual localizer vs. shared responses.
    }
...
\centering
    ...
    \caption{
    %
    Correlations of regressors of movie vs. shared responses.
    }
...
\centering
    ...
    audio-description to model responses correlating with nouns spoken by the
...
\todo[inline]{add estimation of "auditory PPA" here, if supposed to be reported}
...
\todo[inline]{was it transpose of the matrix to warp from MNI into subject?}


\subsection{Quantifying the performance (Pearson + Cronbach's)}

\todo[inline]{add "auditory PPA"}
...
\subsection{Plot of prediction performance}

\todo[inline]{put text here into caption}

%
Pearson correlation coefficients between empirical $Z$-maps (results of
localizer; y-axis) and estimated $Z$-maps (see Figure~\ref{fig:stripplot}).
...
\begin{figure*}[tbp] \centering
    ...
    %
    Correlations between empirical and predicted $Z$-maps.
    %
    PUT INTRO HERE.
    %
...
\label{fig:stripplot} \end{figure*}
