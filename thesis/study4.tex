...
(i.e.  projected into) a \acfi{cas}, such as the
Montreal Neurological Institute brain atlas
\citep[MNI152 atlas;][]{fonov2011unbiased}.
% project into test subject to estimate
Then, data are projected from the \ac{cas} into\todo{?} the
...
aligns vertices to a two-dimensional \ac{cas} \citep[e.g.,
...
in a clinical\todo{drop it} setting to align a test subject, we also explored the relationship
