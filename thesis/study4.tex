...
\centering
    ...
    \caption{
    %
    \textbf{This is a draft.}
    %
    Maybe add matrix notation (s. text).
    }
...
\centering
    ...
    %
    \textbf{Add legend for the median; maybe, add mean, too?}
    %
    Time series and $Z$-maps were masked in the respective subject's voxel
    space by the union of individual \acp{ppa}
    \citep[cf.][]{haeusler2022processing}
    that was warped from MNI152 space into each subjects' voxel space and
...
\todo[inline]{I shifted this up in front; is now more in line with the intro;
primes the (similar but more complicated) functional alignment kind of, too}
...
%
A test subject's \textit{empirical $Z$-map} from the analysis of
%
