...
%
\todo{chose 2 quotes max; use another quote in intro of SRM part}
%
...
%
\todo[inline]{last point is ``problematic'' in case SRM study is dropped}
...
% clinical application
In summary, functional localizer paradigms that aim to characterize the location
...
\todo[inline]{final phrasing of paragraph depends on (non)inclusion of SRM
study}
...
\todo[inline]{If study 4 is dropped, drop the following, preliminary phrasings
(until open science), too}
