...
population.
%
While Consequently, studies that average data across study participants may draw
...
Functional localizers are frequently utilized as a separate experiment to
...
difficult to archieve in clinical or pediatric populations
...
that provide a time-locked event structure,  that sample a broad range of brain
...
\citep[cf.][for reviews]{hamilton2018revolution, hasson2008neurocinematics,
...
\todo[inline]{If SRM is dropped, following sentence makes no sense}
...
\todo[inline]{adjust the following in case SRM study is dropped}
%
...
%
To achieve this, the dissertation followed the guidelines and best practices for
...
published at Neurovault (\href{https://neurovault.org/}{neurovault.org}).
...
\todo[inline]{write a (better) transition from abstract "Open Science" to
specific goals}

\todo[inline]{dropped captions of subsections; one paragraph per study should be
sufficient}
...
localize the \ac{ppa} using \ac{glm} $t$-contrasts based on naturalistic
stimuli annotations.
% AV annotation
