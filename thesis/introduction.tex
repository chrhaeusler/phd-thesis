...
\todo[inline]{write text in SRM study first}
\todo[inline]{text regarding anatomical alignment and functional-anatomical
correspondence should be kept to a minimum here}
...
\todo[inline]{rephrase in line with the (to be written) part regarding.
\ac{cms}}
%
...
\todo[inline]{following is mostly an adjusted text from the project proposal}
