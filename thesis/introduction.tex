...
population.
\todo[inline]{Practical contains "not enough data practically obtainable from
one subject"}
%
...
\todo[inline]{REVISE THIS PART WHILE REVISING THE SRM INTRO}

\todo[inline]{do not introduce (too many too) technical terms; imo training
(data) test(ing data) is okay; must be clear, that we have ``independent''; it
is not just parameter estimation / statistical inference but ``prediction''}
...
\paragraph{just a backup of anatomical alignment procedures}
%
