...
\todo[inline]{provide definition of terms "external" and "ecological validity"}
...
\todo[inline]{Audio stimulus to localize a visual area comes unexpected.  It
...
\todo[inline]{too method-heavy for an intro; move some stuff into SRM part}
