...
\subsection{Functional localizer: pros}
...
diagnostic procedure \citep[cf.,][]{wegrzyn2018thought}.

% purpose: neurosurgery
% For example, surgical procedures might impact the post-operative quality of
% life so much (e.g. concerning cognitive control or speech production) that a
...
\subsection{functional localizer: cons}
% paradigms design for detection power
...
\subsection{Pros: validity \& early findings}
...
impractical as an individual diagnostic procedure is impractical considering
practical and monetary constraints in a clinical context.
...
\subsection{Interim summary of introduction}
...
%
First, naturalistic stimuli offer a fixed time-course of correlating with a
...
%
Thus, a naturalistic stimulus could replace multiple dedicated localizers and
provide a more comprehensive diagnostic routine.
%
...
validity.
%
Second, naturalistic stimuli are an easy-to-follow and immersive paradigm
leading to improved data quality \citep{eickhoff2020towards}.

\todo[inline]{audiobook in visually impaired}
%
...
\subsubsection{Problem: surface-based anatomical alignment is not enough}
%
...
\subsubsection{Solution: functional alignment}
%
