...
annotated; its stated, of course, in specific objectives \& hypotheses}
...
get's super messy there); therefor, the part on Approach 2 can be a little
longer}
...
\todo[inline]{Do not get into details of results!}

\todo[inline]{add visual results}
