...
\todo[inline]{It is not on the theory part above already but here in "Aims of
thesis" for the first time; therfor, the part on Approach 2 can be a little
longer}
...
\todo[inline]{Just speak of "transformations" not "transformation matrices";
it will be about matrices when \ac{srm} is introduced}
...
\todo[inline]{don't write much about results; results are only "important"
regarding how they lead to the next study}

\todo[inline]{Try put all "theory stuff" above; maybe, into 1.3.2 ("Application
1: GLM t-contrasts") and 1.3.4 ("Application 2: Estimation from ref")}
...
\todo[inline]{repeat DataLads functionality here? It's written in the paragraph
above already}
...
\citep[cf.][]{halchenko2021datalad} and enabled me to do the following shit
