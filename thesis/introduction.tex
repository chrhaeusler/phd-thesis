...
\todo[inline]{add: \textit{stimulus classes} are contrasted in GLM analyses}
...
\todo[inline]{check reviews on naturalistic stimuli}
...
%
\todo[inline]{ask Michael: we might not model the response ``correctly'' based
on the subjectively judged/classified stimulus features}
