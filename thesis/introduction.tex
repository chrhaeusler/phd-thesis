...
\todo[inline]{sections are supposed to be numbered (is the not the case in the
papers}
%
...
\todo[inline]{check PuG talk + references there if stuff is not in here already}

\todo[inline]{probably discuss data-driven vs. model-driven here}
%
