...
per study; especially write no "method section"; but mention SRM algo; prime the term "transformations" here, already?}


% 2. estimation from reference
Second, we estimate the results of the visual localizer's $t$-contrast in one
participant from the results of the remaining participants (i.e. \textit{reference
group}).
...
projected into) a \textit{common anatomical space} (CAS), such as the Montreal
Neurological Institute brain atlas \citep[MNI152,][]{fonov2011unbiased}, and
then projected into a new participant's brain anatomy to estimate a functional
